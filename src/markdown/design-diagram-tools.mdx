...
For creating ER diagrams, there are two tools I recommend. If you want to use them in Visual Studio Code, I recommend [bigER Modeling Tool](https://marketplace.visualstudio.com/items?itemName=BIGModelingTools.erdiagram), and if you like to use them online, I highly recommend [dbdiagram.io](https://dbdiagram.io). Both are powerful tools that allow you to create ER diagrams from code.
...
All the above tools can be used inside your code editor, which is very convenient. But if you want a full-featured and freely customizable diagram tool, I recommend [Draw.io](https://app.diagrams.net/). It is a web-based diagramming tool that allows you to create various types of diagrams, including flowcharts, sequence diagrams, ER diagrams, and more. It has a user-friendly interface and a wide range of templates and shapes to choose from.

<MdxImage src="/blog/design-diagram-tools_7.png" alt="design-diagram-tools_7" />

---

For software engineers, I think creating diagrams by visualizing, drawing rectangles, drawing circles... is sometimes harder than coding, so tools that can generate them from code are very helpful. I hope this article helps you find the right tools for your diagramming needs and makes your work easier and more efficient.
